...
class unsuspendSyncWindow(QMainWindow):
    ...
    def _createToolViewLayout(self):
        ...
        UnsuspendSyncLayout, self.input_widgets = gen_custom_tool_layout("Unsuspend Sync", ["Device Name", "Tenant Name"], ["Ignore cert warnings for login", "Verbose Logging"])
    ...
    def tool(self):
        ...
        unsuspend_filer_sync(global_admin, device_name, tenant_name)

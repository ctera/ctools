...
from sharesfromcsv import shares_from_csv
...
class sharesFromCsvWindow(QMainWindow):
    ...
    def _createToolViewLayout(self):
        ...
        tooltip = """Create shares on edge filer using a pre-populated CSV file. Download the template here:
https://github.com/ctera/ctools/blob/main/templates/shares.csv
  -  Address: The IP address of the CTERA Edge Filer
  -  Username: The global admin username of the CTERA edge Filer
  -  Password: The global admin password of the CTERA Edge Filer
  -  CSV File: The path to the CSV file containing the shares and their details
  ...
  DISCLAIMER: This tool's output goes to the commandline window separate from the GUI. Please do not close the commandline window while the tool is running."""
        ...
        tool_name = QLabel("<h2><b>Import Shares from CSV</b></h2>")
        ...
        address = QLabel("Edge Address, hostname, or FQDN")
        self.address_field = QLineEdit()
        
        username = QLabel("Username for Edge Filer Admin")
        self.username_field = QLineEdit()

        password = QLabel("Password for Edge Filer Admin")
    ...
    def tool(self):
        ...
        shares_from_csv(edge_address, edge_username, edge_password, csv_file)

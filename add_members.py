...
def add_user_to_admin(self, user, group, all_devices=False, device_name=None):
    try:
        ...
        if all_devices:
            ...
            filer.groups.add_members('Administrators', [('DU', user), ('DG', group)])

            logging.info("User added to Administrators group")
